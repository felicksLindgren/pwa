...
const routes: Routes = [
  ...
  {
    path: 'speech',
    loadChildren: () => import('./components/speech-recognition/speech-recognition.component').then(c => c.SpeechRecognitionModule),
    data: { title: 'Speech recognition' }
  },
  ...
  {
    path: 'gravity',
    loadChildren: () => import('./components/gravity/gravity.component').then(c => c.GravityModule),
